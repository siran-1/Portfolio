...
export default function Work(){
  ...
  const works = [
    ...
    {name:"ToDo App", img:`${work}`, src:'https://github.com/siran-1/dailyHub'},
    {name:"URLShortner API", img:`${work}`, src:'https://github.com/siran-1/linkShortnerAPI'},
    {name:"ML Model", img:`${work}`, src:'https://github.com/siran-1/RecommendationSystem'},
